...
for file in Files:
    ...
    figure.savefig(f'{root_dir}/Figs/{subject}_{session}_{trial}_Fig1.png')
    plt.close()
    ...
    figure2.savefig(f'{root_dir}/Figs/{subject}_{session}_{trial}_Fig2.png')
    plt.close()
    """
    ...
    figure3.savefig(f'{root_dir}/Figs/{subject}_{session}_{trial}_Fig3.png')
    plt.close()
    ...
    fig.savefig(f'{root_dir}/Figs/{subject}_{session}_{trial}_Fig4.png')
    plt.close()
    ...
    if obstacle_idx != 0:
        ...
        figure6.savefig(f'{root_dir}/Figs/{subject}_{session}_{trial}_Fig6.png')        
