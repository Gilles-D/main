...
for file in Files:
    ...
    # if obstacle_idx != 0 and obstacle_idx !='s6' and obstacle_idx !=10:
    #     if freq != 'None':
    #         plt.plot(-right_foot[1],right_foot[2],color='red',label='Right',alpha=0.1)
    #     else:
    ...
    # figure2.savefig(f'{root_dir}/Figs/{subject}_effets stim full.png')
