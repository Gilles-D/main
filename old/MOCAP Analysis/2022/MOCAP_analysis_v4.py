...
for file in Files:
    ...
    # figure.savefig(f'{root_dir}/Figs/{subject}_{session}_{trial}_Fig1_D_S.png')
    # plt.close()
    ...
    figure3.savefig(f'{root_dir}/Figs/{subject}_{session}_{trial}_Fig3.svg')
    plt.close()
    ...
    """
# figure7 = plt.figure()    
# ax = sns.swarmplot(data=step_obstacle_df,x="Spot",y='Distance',hue='Stim',dodge='True')
