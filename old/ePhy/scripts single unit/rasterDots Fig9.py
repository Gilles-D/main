...
file_path = 'D:/Analyses\Fig 8\Figure\Premier spike/090519-11.xlsx'
file = 'D:/Analyses\Fig 8\Figure\Premier spike/090519-11_spike_times.xlsx'
...
for idx in stim_idx:
    ...
    for s_idx in spike_idx:
        ...
        if s_idx > idx and s_idx <= idx+fenetre or s_idx < idx and s_idx >= idx-fenetre:
            ...
            print(n)
            k = 1
            plt.scatter(spike_raster*1000, n,s=1, c='black')
            N.append([n])
            RASTER.append([spike_raster*1000])
    if k == 0 :
        plt.scatter(1000, n,s=1, c='black')
