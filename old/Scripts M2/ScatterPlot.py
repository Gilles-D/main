...
Lit l'ensemble des fichiers des sous dossiers (date) du dossier data
Représente sur un scatter plot les critères de l'ensemble des spike (ou l'average)
...
#Files location
Datapath1 = 'D:/Analyses\Baseline/data/'
