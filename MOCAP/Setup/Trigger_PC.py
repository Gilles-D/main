...
while 1:
    ...
    if str(arduinoData) == 'Start\r\n':
        ...
        pyautogui.click(217, 974) #Click start Vicon
        Timestamps.append(datetime.fromtimestamp(time.time()))


    if str(arduinoData) == 'Stop\r\n':
        print("Stop Recording")
        pyautogui.click(217, 974) #Click stop Vicon
        pyautogui.click(1888, 44) #Click stop AMP
        time.sleep(0.5)#Sleep    
        pyautogui.click(1888, 44) #Click reset AMP
