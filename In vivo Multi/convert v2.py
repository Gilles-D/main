...
if __name__ == '__main__':
    ...
    folderpath = rf'D:\Working_Dir\In vivo Mars 2022\H5'
    
    for subfolder in os.walk(folderpath):
        experience_list.append((subfolder[0].split('\\'))[-1])  
    
    if experience_list[0]=='H5':
        experience_list.pop(0)
    ...
    for experience in experience_list:
        ...
        if not isExist:
            os.makedirs(RBF_path)
        convert_folder(H5_path, RBF_path)
