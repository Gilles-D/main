...
# Working folder path
working_dir=r'\\equipe2-nas1\Gilles.DELBECQ\Data\ePhy\Février2023\Test_Gustave'
recording_dir='Gust_27_02_baseline_fixed2'

sorting_saving_dir=rf'Sorted/{recording_dir}'
...
"""
#Load the recordings
recording_loaded = si.load_extractor(rf"{working_dir}\raw\raw si\{recording_dir}")
...
sorting_outputs = ss.run_sorters(sorter_list=["tridesclous"],
                                 ...
                                 working_folder=rf"{working_dir}\{sorting_saving_dir}",
                                 verbose=True,
                                 engine="joblib",
...
#Save sorting output
TDC_output_saved = TDC_output.save(folder=rf'{working_dir}\{recording_dir}\{sorting_saving_dir}_TDC/') 
...
we = si.extract_waveforms(recording_loaded, TDC_output, folder=rf"{working_dir}\{recording_dir}\{sorting_saving_dir}_TDC/Waveforms", 
...
we_all = si.extract_waveforms(recording_loaded, TDC_output, folder=rf"{working_dir}\{recording_dir}\{sorting_saving_dir}_TDC/Waveforms_all", 
