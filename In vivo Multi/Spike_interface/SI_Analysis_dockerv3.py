...
rec_binary = recording_cmr.save(folder=rf'C:\Users\MOCAP\Desktop\temp\{saving_name}_sorting2', n_jobs=1, progress_bar=True, chunk_duration='1s')
...
for i in range(len(sorter_list_cleaned)):
    ...
    try :
        sexp.export_to_phy(we, output_folder=rf'C:\Users\MOCAP\Desktop\temp\0012_03_07_sorting2\phy_export\{sorter_name_list[i]}', 
