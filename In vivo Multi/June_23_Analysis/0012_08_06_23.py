...
savefig_folder=r"C:\Users\MOCAP\Desktop\Spikesorting_09_06"
...
number_spike_cum = np.arange(len(selected_spike_times[0])) + 1
plt.plot(selected_spike_times[0], number_spike_cum, marker='o')
