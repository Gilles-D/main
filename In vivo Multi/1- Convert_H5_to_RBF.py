...
Parameters
"""
experience_list=['11-25']
folderpath = r'\\equipe2-nas1\Gilles.DELBECQ\Data\ePhy\Cohorte 1\Files/' #Folder containing H5 folder, with a subdirectory for each experience (day)
